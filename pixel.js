function UET(o) {
    ...
    this.domain = "meow.alexsmirnov.com/domain";
    this.domainCl = "meow.alexsmirnov.com/domain-cl";
    ...
    this.uetConfig.cusig = {hasLoaded: !1, timeoutId: null, blob: {}};
    this.beaconParams = {};
    ...
    this.evqDispatch = !1;
    this.evqCDispatch = !1;
    this.processEarly = {set: 1, consent: 1, config: 1};
    ...
    this.checkuetHostdocumentload = function () {
        ...
        if (n.evqCDispatch === !1) for (n.dispatchq(!0), n.evqCDispatch = !0, t = 0; t < n.eventPushQueue.length; t++) n.eventPushQueue[t] instanceof Array && n.processEarly[n.eventPushQueue[t][0]] && n._push(n.eventPushQueue[t]);
    ...
    this.loadConfig = function () {
        ...
        v = o.Ver !== 1 ? {ti: 0, Ver: 0, tm: 1, Tag: 0, EXT_Data: 0} : {Ver: 0, tagId: 0, Tag: 0, Sig: 0, EXT_Data: 0};
        for (f in o) v.hasOwnProperty(f) && (this.beaconParams[f] = v[f] === 1 ? encodeURIComponent(o[f]) : o[f]);
        for (this.beaconParams.mid = this.getUuidV4(!0), this.beaconParams.bo = 0, t = undefined, y = 0; y < 5; y++) if (t = "ueto_" + this.makeRandomStr(10), !window[t]) break;
    ...
    this._push = function (n) {
        ...
        if (n[1] instanceof Array) if (n[0] === "event") {
            ...
            for (i in n[1][0]) this.knownParams.hasOwnProperty(i) && (this.pageLevelParams[i] = n[1][0][i], i === "pid" && this.pageLoadDispatch === !0 && (e = this.validateSubparams({pid: n[1][0][i]}, ""), e.hasOwnProperty("pid") && this.firePidEvent(e.pid)))
        } else if (n[0] === "consent") {
            if (t = n[1][1], f = n[1][0], t === null || typeof t != "object") return;
            if (o = !1, t.hasOwnProperty("source") && this.stringExists(t.source) && t.source.indexOf("gtm_") === 0) if (t.source === "gtm_update" && t.hasOwnProperty("ad_storage")) {
                if (!(this.uetConfig.cusig.blob.ec === !0 || this.uetConfig.cusig.blob.ea === !0)) {
                    this.fireSendBeacon("gtmConsent", {gasc: t.ad_storage !== "denied" ? "G" : "D"});
                    return
                }
                o = !0
            } else return;
            this.uetConfig.consent.enabled = !0;
            f === "default" ? (t.hasOwnProperty("ad_storage") && this.uetConfig.consent.adStorageUpdated === !1 && (this.uetConfig.consent.adStorageAllowed = t.ad_storage !== "denied", this.uetConfig.consent.enforced = !1, this.uetConfig.tcf.auto === !0 && (this.uetConfig.tcf.enabled = !1, this.uetConfig.tcf.auto = !1)), this.handleCookieIds(), this.fireConsentPing("default"), t.hasOwnProperty("wait_for_update") && (r = parseInt(t.wait_for_update, 10), !isNaN(r) && r > 0 && (r = Math.min(r, 1e4), this.uetConfig.consent.waitForUpdate = r))) : f === "update" && t.hasOwnProperty("ad_storage") && (this.uetConfig.consent.adStorageAllowed = t.ad_storage !== "denied", this.uetConfig.consent.adStorageUpdated = !0, this.uetConfig.consent.enforced = !1, this.uetConfig.tcf.auto === !0 && (this.uetConfig.tcf.enabled = !1, this.uetConfig.tcf.auto = !1), this.handleCookieIds(), o && this.fireSendBeacon("gtmConsent", {gasc: t.ad_storage !== "denied" ? "G" : "D"}), this.fireConsentPing("update"))
        } else if (n[0] === "config") {
            if (t = n[1][1], f = n[1][0], t === null || typeof t != "object") return;
    ...
    this.addUrlData = function (n, t) {
        ...
        if (t = t === !0, f = !1, window.window != window.top) try {
            for (e = 0, r = window.window; e <= 5 && r != null && r != window.top; e++, r = r.parent) if (r.document != null && this.stringExists(r.document.referrer) && r.document.referrer.toLowerCase() !== "about:blank") {
    ...
    this.setCookie = function (n, t, i, r, u, f, e) {
        ...
        if (s = null, i > 0 && (s = new Date, s.setTime(s.getTime() + i * 1e3)), l = new Date, l.setTime(0), u && s != null && this.setLocalStorageBackup(n, t, i), this.domainName === null || r) {
            if (c = this.getHostname(), c && typeof c == "string" && c !== "localhost") for (h = c.split("."), o = h.pop(), h.length === 3 && Number(o) >= 0 && (h = []); h.length > 0;) if ((o = h.pop() + "." + o, this.uetConfig.cookieDomain === "" || this.uetConfig.cookieDomain.toLowerCase() === o.toLowerCase()) && (r && (this._setCookie(n, "", l, o, this.uetConfig.cookieFlags), r = !!this.getCookie(n, f, e)), !r && (this._setCookie(n, f + t, s, o, this.uetConfig.cookieFlags), this.getCookie(n, f, e)))) {
                this.domainName = o;
                return
            }
            this.domainName = ""
    ...
    this.addCookieId = function (n, t, i, r, u) {
        ...
        var e = "2", h = !0, f = this.getCookie(r, "", this.insightsCookieMaxLength);
    ...
    this.firePidEvent = function (n) {
        ...
        t = this.combine(this.beaconParams, {evt: "pid", pid: n});
    ...
    this.fireSendBeacon = function (n, t) {
        ...
        if (this.uetConfig.msDns !== !0) {
            this.beaconParams.bo = (this.beaconParams.bo || 0) + 1;
            i = this.combine(this.beaconParams, {evt: n});
            t && (i = this.clone(t, i));
            i = this.addConsentParams(i);
    ...
    this.getCmpData = function () {
        var n;
        try {
            var t = [{c: "OptanonConsent", f: "Optanon"}, {c: "CookieConsent", f: "CookieConsent"}, {
                c: "ucconsent",
                f: "Usercentrics"
            }, {c: "_osano_consent", f: "osano"}, {c: "ketch_consent", f: "ketch"}, {
                c: "didomi_token",
                f: "didomi"
            }, {c: "cookieyes-consent", f: "cookieyes"}, {
                c: "consent_manager",
                f: "TrustArc"
            }, {c: "cookiescriptaccept", f: "CookieScript"}, {c: "euconsent-v2", f: "__cmp"}, {
                c: "iubenda_consent",
                f: "iubenda"
            }, {c: "utag_main", f: "utag"}, {
                c: "CookieInformationConsent",
                f: "CookieInformation"
            }, {c: "mineos_consent", f: "mineos"}, {c: "termly_consent", f: "termly"}, {
                c: "privacytools_consent",
                f: "privacytools"
            }, {c: "seersConsent", f: "SeersConsentManagementPlatform"}, {
                c: "ethyca_consent",
                f: "ethyca"
            }, {c: "_pk_ref", f: "PiwikPro"}, {c: "secureprivacy_consent", f: "SecurePrivacy"}, {
                c: "borlabs-cookie",
                f: "borlabsCookie"
            }, {c: "salesforce_consent", f: "SalesforceConsent"}, {
                c: "ibmsecurityverify_consent",
                f: "IBMVerify"
            }, {c: "adopt_consent", f: "adopt"}, {c: "illow_consent", f: "illow"}, {
                c: "ajs_consent",
                f: "analytics"
            }, {c: "cact_consent", f: "CommandersAct"}, {
                c: "complianz_consent",
                f: "Complianz"
            }, {c: "consentmanager_consent", f: "consentmanager"}, {c: "sirdataconsent", f: "Sirdata"}], i = 0, r = !1;
            for (n = 0; n < t.length; n++) if (window.hasOwnProperty(t[n].f)) {
                i = n + 1;
                r = this.stringExists(this.getCookie(t[n].c, "", 4096)) === !0;
                break
            }
            return {cmp: i, hasCookie: r}
        } catch (u) {
        }
        return {cmp: 0, hasCookie: !1}
    };
    this.buildConsentDetectionBlob = function () {
        var n = this.getCmpData(), t = typeof __tcfapi == "function", i = this.uetConfig.consent.enforced === !0,
            r = this.uetConfig.cusig.hasLoaded === !0, u = 0 | n.cmp != 0 | n.hasCookie << 1 | t << 2 | i << 3 | r << 4;
    ...
    this.addConsentParams = function (n) {
        if (this.uetConfig.consent.enabled === !0 && (n.asc = this.uetConfig.consent.adStorageAllowed ? "G" : "D"), this.uetConfig.tcf.enabled === !0 && (this.uetConfig.tcf.auto === !1 || this.uetConfig.tcf.hasVendor === !0)) {
            var t = {st: this.uetConfig.tcf.hasLoaded === !0 ? "L" : "E"};
    ...
    this.wrapHistoryMethod = function (n) {
        if (window.history && window.history[n]) {
            var t = window.history[n], i = this.documentUrlChanged.bind(this, n);
    ...
    this.insightsSetCookie = function (n, t) {
        ...
        if (this.isAdStorageAllowed() && this.stringExists(n) && !(n.length > this.insightsDataMaxLength)) {
            var r = t === 0 ? this.sessionCookieName : this.uetConfig.vidCookie, u = !0,
